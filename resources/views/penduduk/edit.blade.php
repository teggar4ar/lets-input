                        ...
                        <div class="mb-8 bg-gray-100 p-6 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="no_kk" id="no_kk" class="mt-1 p-2 w-full border rounded-md @error('no_kk') border-red-500 @enderror" value="{{ old('no_kk', $penduduk->no_kk) }}" readonly>
                                    @error('no_kk')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="nik" id="nik" class="mt-1 p-2 w-full border rounded-md @error('nik') border-red-500 @enderror" value="{{ old('nik', $penduduk->nik) }}" required>
                                    @error('nik')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="alamat" id="alamat" rows="2" class="mt-1 p-2 w-full border rounded-md @error('alamat') border-red-500 @enderror" required>{{ old('alamat', $penduduk->alamat->nama_alamat) }}</textarea>
                                @error('alamat')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <select name="dusun" id="dusun" class="mt-1 p-2 w-full border rounded-md @error('dusun') border-red-500 @enderror" required>
                                        @foreach(['001', '002', '003', '004', '005', '006', '007'] as $dusun)
                                            <option value="{{ $dusun }}" {{ old('dusun', $penduduk->alamat->dusun) == $dusun ? 'selected' : '' }}>{{ $dusun }}</option>
                                        @endforeach
                                    </select>
                                    @error('dusun')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="no_rt" id="no_rt" class="mt-1 p-2 w-full border rounded-md @error('no_rt') border-red-500 @enderror" value="{{ old('no_rt', $penduduk->alamat->no_rt) }}" required>
                                    @error('no_rt')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="no_rw" id="no_rw" class="mt-1 p-2 w-full border rounded-md @error('no_rw') border-red-500 @enderror" value="{{ old('no_rw', $penduduk->alamat->no_rw) }}" required>
                                    @error('no_rw')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="bg-gray-100 p-6 rounded-lg mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="nama" id="nama" class="mt-1 p-2 w-full border rounded-md @error('nama') border-red-500 @enderror" value="{{ old('nama', $penduduk->nama) }}" required>
                                    @error('nama')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="tmp_lahir" id="tmp_lahir" class="mt-1 p-2 w-full border rounded-md @error('tmp_lahir') border-red-500 @enderror" value="{{ old('tmp_lahir', $penduduk->tmp_lahir) }}" required>
                                    @error('tmp_lahir')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="date" name="tgl_lahir" id="tgl_lahir" class="mt-1 p-2 w-full border rounded-md @error('tgl_lahir') border-red-500 @enderror" value="{{ old('tgl_lahir', $penduduk->tgl_lahir) }}" required>
                                    @error('tgl_lahir')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="agamas_id" id="agamas_id" class="mt-1 p-2 w-full border rounded-md @error('agamas_id') border-red-500 @enderror" required>
                                        @foreach($agamas as $agama)
                                            <option value="{{ $agama->id }}" {{ old('agamas_id', $penduduk->agamas_id) == $agama->id ? 'selected' : '' }}>{{ $agama->nama_agama }}</option>
                                        @endforeach
                                    </select>
                                    @error('agamas_id')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select name="pendidikans_id" id="pendidikans_id" class="mt-1 p-2 w-full border rounded-md @error('pendidikans_id') border-red-500 @enderror" required>
                                        @foreach($pendidikans as $pendidikan)
                                            <option value="{{ $pendidikan->id }}" {{ old('pendidikans_id', $penduduk->pendidikans_id) == $pendidikan->id ? 'selected' : '' }}>{{ $pendidikan->nama_pendidikan }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="pendidikan_sedangs_id" id="pendidikan_sedangs_id" class="mt-1 p-2 w-full border rounded-md @error('pendidikan_sedangs_id') border-red-500 @enderror">
                                        ...
                                        @foreach($pendidikanSedangs as $pendidikanSedang)
                                            <option value="{{ $pendidikanSedang->id }}" {{ old('pendidikan_sedangs_id', $penduduk->pendidikan_sedangs_id) == $pendidikanSedang->id ? 'selected' : '' }}>{{ $pendidikanSedang->nama_pendidikan_sedangs }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="pekerjaans_id" id="pekerjaans_id" class="mt-1 p-2 w-full border rounded-md @error('pekerjaans_id') border-red-500 @enderror" required>
                                        @foreach($pekerjaans as $pekerjaan)
                                            <option value="{{ $pekerjaan->id }}" {{ old('pekerjaans_id', $penduduk->pekerjaans_id) == $pekerjaan->id ? 'selected' : '' }}>{{ $pekerjaan->nama_pekerjaan }}</option>
                                        @endforeach
                                    </select>
                                    @error('pekerjaans_id')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select name="stat_kawins_id" id="stat_kawins_id" class="mt-1 p-2 w-full border rounded-md @error('stat_kawins_id') border-red-500 @enderror" required>
                                        @foreach($statKawins as $statKawin)
                                            <option value="{{ $statKawin->id }}" {{ old('stat_kawins_id', $penduduk->stat_kawins_id) == $statKawin->id ? 'selected' : '' }}>{{ $statKawin->nama_stat_kawins }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="stat_hub_keluargas_id" id="stat_hub_keluargas_id" class="mt-1 p-2 w-full border rounded-md @error('stat_hub_keluargas_id') border-red-500 @enderror" required>
                                        @foreach($statHubKeluargas as $statHubKeluarga)
                                            <option value="{{ $statHubKeluarga->id }}" {{ old('stat_hub_keluargas_id', $penduduk->stat_hub_keluargas_id) == $statHubKeluarga->id ? 'selected' : '' }}>{{ $statHubKeluarga->nama_hub_keluarga }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div>
                                    ...
                                    <select name="kewarganegaraan" id="kewarganegaraan" class="mt-1 p-2 w-full border rounded-md @error('kewarganegaraan') border-red-500 @enderror" required>
                                        ...
                                        <option value="dua kewarganegaraan" {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 'dua kewarganegaraan' ? 'selected' : '' }}>Dua Kewarganegaraan</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="gol_darahs_id" id="gol_darahs_id" class="mt-1 p-2 w-full border rounded-md @error('gol_darahs_id') border-red-500 @enderror">
                                        ...
                                        @foreach($golDarahs as $golDarah)
                                            <option value="{{ $golDarah->id }}" {{ old('gol_darahs_id', $penduduk->gol_darahs_id) == $golDarah->id ? 'selected' : '' }}>{{ $golDarah->nama_gol_darah }}</option>
                                        @endforeach
                                    </select>
                                    @error('gol_darahs_id')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="suku" id="suku" class="mt-1 p-2 w-full border rounded-md @error('suku') border-red-500 @enderror" value="{{ old('suku', $penduduk->suku) }}">
                                    @error('suku')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="bg-gray-100 p-6 rounded-lg mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="ayah_nik" id="ayah_nik" class="mt-1 p-2 w-full border rounded-md @error('ayah_nik') border-red-500 @enderror" value="{{ old('ayah_nik', $penduduk->ayah_nik) }}">
                                    @error('ayah_nik')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="ayah_nama" id="ayah_nama" class="mt-1 p-2 w-full border rounded-md @error('ayah_nama') border-red-500 @enderror" value="{{ old('ayah_nama', $penduduk->ayah_nama) }}">
                                    @error('ayah_nama')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="ibu_nik" id="ibu_nik" class="mt-1 p-2 w-full border rounded-md @error('ibu_nik') border-red-500 @enderror" value="{{ old('ibu_nik', $penduduk->ibu_nik) }}">
                                    @error('ibu_nik')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="ibu_nama" id="ibu_nama" class="mt-1 p-2 w-full border rounded-md @error('ibu_nama') border-red-500 @enderror" value="{{ old('ibu_nama', $penduduk->ibu_nama) }}">
                                    @error('ibu_nama')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="bg-gray-100 p-6 rounded-lg mb-6">
                                ...
                                <div>
                                    ...
                                    <select name="cacats_id" id="cacats_id" class="mt-1 p-2 w-full border rounded-md @error('cacats_id') border-red-500 @enderror">
                                        ...
                                        @foreach($cacats as $cacat)
                                            <option value="{{ $cacat->id }}" {{ old('cacats_id', $penduduk->cacats_id) == $cacat->id ? 'selected' : '' }}>{{ $cacat->nama_cacat }}</option>
                                        @endforeach
                                    </select>
                                    @error('cacats_id')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select name="cara_kbs_id" id="cara_kbs_id" class="mt-1 p-2 w-full border rounded-md @error('cara_kbs_id') border-red-500 @enderror">
                                        ...
                                        @foreach($caraKbs as $caraKb)
                                            <option value="{{ $caraKb->id }}" {{ old('cara_kbs_id', $penduduk->cara_kbs_id) == $caraKb->id ? 'selected' : '' }}>{{ $caraKb->nama_cara_kb }}</option>
                                        @endforeach
                                    </select>
                                    @error('cara_kbs_id')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select name="asuransis_id" id="asuransis_id" class="mt-1 p-2 w-full border rounded-md @error('asuransis_id') border-red-500 @enderror">
                                        ...
                                        @foreach($asuransis as $asuransi)
                                            <option value="{{ $asuransi->id }}" {{ old('asuransis_id', $penduduk->asuransis_id) == $asuransi->id ? 'selected' : '' }}>{{ $asuransi->nama_asuransi }}</option>
                                        @endforeach
                                    </select>
                                    @error('asuransis_id')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select name="stat_rekams_id" id="stat_rekams_id" class="mt-1 p-2 w-full border rounded-md @error('stat_rekams_id') border-red-500 @enderror">
                                        ...
                                        @foreach($statRekams as $statRekam)
                                            <option value="{{ $statRekam->id }}" {{ old('stat_rekams_id', $penduduk->stat_rekams_id) == $statRekam->id ? 'selected' : '' }}>{{ $statRekam->nama_stat_rekam }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="stat_dasars_id" id="stat_dasars_id" class="mt-1 p-2 w-full border rounded-md @error('stat_dasars_id') border-red-500 @enderror" required>
                                        @foreach($statDasars as $statDasar)
                                            <option value="{{ $statDasar->id }}" {{ old('stat_dasars_id', $penduduk->stat_dasars_id) == $statDasar->id ? 'selected' : '' }}>{{ $statDasar->nama_stat_dasars }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="flex space-x-6 mt-4">
                                <div class="flex items-center">
                                    <input type="checkbox" name="ktp_el" id="ktp_el" class="mr-2" {{ old('ktp_el', $penduduk->ktp_el) ? 'checked' : '' }}>
                                    <label for="ktp_el" class="text-sm font-medium text-gray-700">KTP Elektronik</label>
                                </div>

                                @if($penduduk->jk == 'perempuan')
                                <div class="flex items-center">
                                    <input type="checkbox" name="hamil" id="hamil" class="mr-2" {{ old('hamil', $penduduk->hamil) ? 'checked' : '' }}>
